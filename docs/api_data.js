define({ "api": [
  {
    ...
    "url": "/events/:event_id",
    "title": "Delete event",
    "description": "<p>Deletes an event.</p>",
    "name": "DeleteEvent",
    "group": "Event",
    "header": {
      "fields": {
  ...
  },
  {
    ...
    "description": "<p>Shows templates.</p>",
    "name": "GetTemplate",
    "group": "EventTemplate",
    "header": {
      "fields": {
    ...
    "filename": "app/Http/Controllers/EventTemplateController.php",
    "groupTitle": "EventTemplate"
  },
  {
    "version": "0.0.1",
    "type": "post",
    "url": "/eventTemplates",
    "title": "Post event template",
    "description": "<p>Creates a new template.</p>",
    "name": "PostTemplate",
    "group": "EventTemplate",
    "header": {
      "fields": {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "event_id",
            "description": "<p>Event which will serve as a base for the template</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>New event template id</p>"
          }
        ]
      }
    },
